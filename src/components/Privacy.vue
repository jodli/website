<template>
  <div class="privacy">
    <vj-storyblock id="policy">
      <vj-content :max-width="800">
        <h1>Privacy Policy</h1>
        <p>This privacy notice discloses the privacy practices for visualjerk.de. This privacy notice applies solely to information collected by this website. It will notify you of the following:
        </p>
        <ol>
          <li>
        ...
        <p>
          Wherever we collect sensitive information (such as credit card data), that information is encrypted and transmitted to us in a secure way. You can verify this by looking for a lock icon in the address bar and looking for "https" at the beginning of the address of the Web page.</p>
        <p>
        ...
        <p>If you feel that we are not abiding by this privacy policy, you should contact us immediately via telephone at 0175 164 43 43 or via email (<a href="mailto:hello@visualjerk.de">hello@visualjerk.de</a>).
        </p>
      </vj-content>
    </vj-storyblock>
  </div>
